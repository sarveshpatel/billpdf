...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2021 at 09:20 AM
...
(682, 123456, '2021-09-10 11:55:00', 'Test', 'sdfdsf', '157.00', '0.00', '0', 157.00, '157.00', '0.00', 'sadsdwsdsd');
...
(4364, 682, '1', '2 papers', '2.00', '23.00', '46.00'),
(4365, 682, '2', 'sdsd', '1.00', '111.00', '111.00');
...
--
ALTER TABLE `invoice_order_item`
  MODIFY `order_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4366;
